 ...
 *
 * $Header: /u/lili/cvsroot/OPRCoding/NetCode/GaloisField.h,v 1.2 2008/09/10 04:37:56 yzhang Exp $
 */
...
public:
  ...
  // compute a+b
  uint64 Add(uint64 a, uint64 b) const { return a ^ b; }

  // compute a-b
  uint64 Sub(uint64 a, uint64 b) const { return a ^ b; }
